...
var (
	...
	ErrTokenExpired         *echo.HTTPError = echo.NewHTTPError(http.StatusBadRequest, "token expired")
	ErrInvalidInput         *echo.HTTPError = echo.NewHTTPError(http.StatusBadRequest, "invalid input")
